...
draw_sprite_ext(spr_button_faq,b2,room_width/2+344,room_height/2,2,2,0,c2,1);
 ...
 scr_text(room_width/2-172, room_height/2-344,"1",1.5,1.5,t1a);
 scr_text(room_width/2+344, room_height/2-344,"2",1.5,1.5,t2a);
 scr_text(room_width/2+172, room_height/2-344,"3",1.5,1.5,t3a);
