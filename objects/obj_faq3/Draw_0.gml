...
//draw_sprite_ext(spr_button_faq,b1,room_width/2-96,room_height/2,1,1,0,c1,1);
draw_sprite_ext(spr_button_faq,b3,room_width/2+96,room_height/2,1,1,0,c3,1);
//draw_sprite_ext(spr_button_faq,0,room_width/2-192,room_height/2,1,1,0,c5,1);
//draw_sprite_ext(spr_button_faq,b2,room_width/2+192,room_height/2,1,1,0,c2,1);
...
draw_sprite_ext(spr_button_faq,0,room_width/2+96,room_height/2,1,1,0,c3,1);
draw_sprite_ext(spr_button_faq,0,room_width/2,room_height/2,1,1,0,c4,1);
shader_reset();
...
draw_sprite_ext(spr_button_faq,b2,room_width/2-192,room_height/2,1,1,0,c5,1);
draw_sprite_ext(spr_button_faq,b1,room_width/2-96,room_height/2,1,1,0,c1,1);
draw_sprite_ext(spr_button_faq,b3,room_width/2+192,room_height/2,1,1,0,c2,1);
shader_reset();
...
draw_sprite_stretched(spr_line,0,room_width/2-252,room_height/2+96,t*504/800,20);
