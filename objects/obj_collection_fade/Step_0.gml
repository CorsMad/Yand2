...
switch(work)
{
	...
	case 1:
		...
		{
			if point_in_rectangle(mouse_x,mouse_y,256-_offset,544+32-_offset+64,256+_offset,544+32+_offset+64)
			{
				if obj_global_controller.but_graph != 0 {obj_global_controller.but_graph = 0;scr_snd_menu(snd_button_click1);;	}				
			}
			if point_in_rectangle(mouse_x,mouse_y,544-_offset,544+32-_offset+64,544+_offset,544+32+_offset+64) && finished_count >=3
			{
				if obj_global_controller.but_graph!=1
				{
					...
					for (var i = 0; i < 4; i++) {
						instance_create_depth(544,544+64,depth-1,obj_but_graph_star1);
					}
				}
			}
			if point_in_rectangle(mouse_x,mouse_y,832-_offset,544+32-_offset+64,832+_offset,544+32+_offset+64) && finished_count >=6
			{
				if obj_global_controller.but_graph != 2
				{
					...
					scr_snd_menu(snd_button_click1);
					instance_create_depth(832,544-24+64,depth-1,obj_but_graph_rocket2);
				}
			}
			if point_in_rectangle(mouse_x,mouse_y,256-_offset,832+32-_offset+64,256+_offset,832+32+_offset+64) && finished_count >=9
			{
				if obj_global_controller.but_graph != 3
				{
					...
					scr_snd_menu(snd_button_click1);
					for (var i = 0; i < 6; i++) {
						instance_create_depth(256+random_range(-64,64),832+random_range(-64,64)+64,depth-1,obj_but_grap_flower);
					}
				}
			}
			if point_in_rectangle(mouse_x,mouse_y,544-_offset,832+32-_offset+64,544+_offset,832+32+_offset+64) && finished_count >=12
			{
				if obj_global_controller.but_graph != 4
				{
					...
					i_cr.x_cr = mouse_x;
					i_cr.y_cr = mouse_y;
					instance_create_depth(544,832+64,depth-1,obj_but_graph_light_1);
				}
			}
			if point_in_rectangle(mouse_x,mouse_y,832-_offset,832+32-_offset+64,832+_offset,832+32+_offset+64) && finished_count >=15
			{
				if obj_global_controller.but_graph != 5
				{
					...
					scr_snd_menu(snd_button_click1);
					instance_create_depth(832,832-24+64,depth-1,obj_but_graph_firework);
				}
			}
			if point_in_rectangle(mouse_x,mouse_y,256-_offset,1120+32-_offset+64,256+_offset,1120+32+_offset+64) && finished_count >=18
			{
				if obj_global_controller.but_graph != 6
				{
					...
					scr_snd_menu(snd_button_click1);
					#region graph
					var inst1 = instance_create_depth(256-random_range(0,16),1120+random_range(0,16)+64,depth-1,obj_but_graph_buttefrly)	
					inst1.image_xscale = 2;
					inst1.hspd = random_range(-8,-1);
					inst1.vspd = -random_range(0,3);
	
					var inst2 = instance_create_depth(256-random_range(0,16),1120+random_range(-16,0)+64,depth-1,obj_but_graph_buttefrly)	
					inst2.image_xscale = 2;
					inst2.hspd = random_range(-8,-1);
					inst2.vspd = -random_range(3.1,6);
	
					var inst3 = instance_create_depth(256+random_range(0,16),1120+random_range(0,16)+64,depth-1,obj_but_graph_buttefrly)	
					inst3.image_xscale = -2;
					inst3.hspd = random_range(1,8);
					inst3.vspd = -random_range(0,3);
	
					var inst4 = instance_create_depth(256+random_range(0,16),1120+random_range(-16,0)+64,depth-1,obj_but_graph_buttefrly)	
			...
			if point_in_rectangle(mouse_x,mouse_y,544-_offset,1120+32-_offset+64,544+_offset,1120+32+_offset+64) && finished_count >=21
			{
				if obj_global_controller.but_graph != 7
				{
					...
					scr_snd_menu(snd_button_click1);
					var i1 = instance_create_depth(544,1120+64,depth-1,obj_but_graph_laser);
					var i2 = instance_create_depth(544,1120+64,depth-1,obj_but_graph_laser);
					i1.rot = 0;
					i2.rot = 90;
				}
			}
			if point_in_rectangle(mouse_x,mouse_y,832-_offset,1120+32-_offset+64,832+_offset,1120+32+_offset+64) && finished_count >=24
			{
				if obj_global_controller.but_graph != 8
				{
					...
					for (var i = 0; i < 4; i++) {
					    instance_create_depth(832,1120-20+64,depth-1,obj_but_graph_music);
					}
