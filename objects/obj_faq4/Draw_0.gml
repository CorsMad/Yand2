...
draw_sprite_ext(spr_button_faq,b3,room_width/2,    room_height/2,2,2,0,c3,1);
draw_sprite_ext(spr_button_faq,b2,room_width/2-172,room_height/2,2,2,0,c2,1);
draw_sprite_ext(spr_button_faq,b4,room_width/2+172,room_height/2,2,2,0,c4,1);
draw_sprite_ext(spr_button_faq,b1,room_width/2-344,room_height/2,2,2,0,c1,1);
draw_sprite_ext(spr_button_faq,b5,room_width/2+344,room_height/2,2,2,0,c5,1);
...
draw_sprite_stretched(spr_line,0,room_width/2-470,room_height/2+150,t*936/560,60);
